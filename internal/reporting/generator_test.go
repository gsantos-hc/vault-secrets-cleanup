...
func TestGeneratorGenerate(t *testing.T) {
	...
	plan := &vpb.DeletionPlan{
		...
		Actions: []*vpb.SecretAction{
			{NamespacePath: "prod/app", MountPath: "secret/", SecretPath: "old/config", Category: "stale", Reason: "old"},
	...
	require.NoError(t, err)
	require.Contains(t, out, "namespace_path,mount_path,secret_path,category,reason")
